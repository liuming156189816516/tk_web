                  ...
                  <el-col :span="24">
                    <el-col :span="8">
                      <el-select v-model="genre.label" :placeholder="$t('sys_c052')">
                        <el-option v-for="(item,idx) in screenOptions" v-show="idx!=0" :key="item.value" :disabled="item.check" :label="item.name" :value="item.value" />
                      </el-select>
                    </el-col>
                      ...
                      <el-col :span="8">
                        <el-select v-model="genre.blong" :placeholder="$t('sys_c052')">
                          <template v-if="genre.label==2">
                            <el-option v-for="(item,idx) in termOptions" v-show="idx!=0&&idx!=3&idx!=4" :key="idx" :label="item" :value="idx" />
                          </template>
                          <template v-else>
                            <el-option v-for="(item,idx) in termOptions" v-show="item!=''" :key="idx" :label="item" :value="idx" />
                          </template>
                        </el-select>
                      </el-col>
                      <el-col v-if="genre.blong==1||genre.blong==2" :span="8">
                        <el-input v-model="genre.reason" :placeholder="$t('sys_mat061',{value:screenOptions[genre.label].name})" clearable />
                      </el-col>
                    </template>
